...
import { default as BoardJumpSturdy } from '../jump-sturdy/mainboard';
import { default as GameJumpySturdy } from '../jump-sturdy/game';
import './lobby.css';

GameTicTacToe.minPlayers = 1;
GameTicTacToe.maxPlayers = 2;
GameChess.minPlayers = GameChess.maxPlayers = 2;
GameJumpySturdy.minPlayers = 1;
GameJumpySturdy.maxPlayers = 2;

const hostname = window.location.hostname;
const importedGames = [
  { game: GameTicTacToe, board: BoardTicTacToe },
  { game: GameChess, board: BoardChess },
  { game: GameJumpySturdy, board: BoardJumpSturdy},
];
